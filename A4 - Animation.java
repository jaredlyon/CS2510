...
class DotsWorld extends World {
  ...
  // test method for onTick using seeded randomness
  public World onTickTesting() {
    ILoDot add = new ConsLoDot(new Dot(10, Color.magenta, 1), this.dots);
    return new DotsWorld(add.move());
  }
...
class ExamplesAnimation {
  ...
  Dot d1Moved = new Dot(10, Color.magenta, 513, 175);
  Dot d2Moved = new Dot(10, Color.magenta, 292, 95);
  Dot d3Moved = new Dot(10, Color.magenta, 518, 383);
  ...
  ILoDot lod3Moved = new ConsLoDot(this.d3Moved,
      new ConsLoDot(this.d2Moved,
          new ConsLoDot(this.d1Moved, this.mt)));
  ...
  boolean testMove(Tester t) {
    return t.checkExpect(this.d4.move(), this.d6) 
        ...
        && t.checkExpect(this.lod3.move(), this.lod3Moved);
  }
  ...
  boolean testOnTick(Tester t) {
    return t.checkExpect(this.dw1.onTickTesting(),
        new DotsWorld(new ConsLoDot(new Dot(10, Color.magenta, 1), this.dw1.dots).move()))
        && t.checkExpect(this.dw2.onTickTesting(),
            new DotsWorld(new ConsLoDot(new Dot(10, Color.magenta, 1), this.dw2.dots).move()))
        && t.checkExpect(this.dw3.onTickTesting(),
            new DotsWorld(new ConsLoDot(new Dot(10, Color.magenta, 1), this.dw3.dots).move()));
  }
